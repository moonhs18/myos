...
CFLAGS	:= -Wall -Wextra -O2 -ffreestanding -nostdlib -nostartfiles -Iuart -Ikernel -Itest -Ipmm
...
SRCS_C	:= kernel/kernel.c kernel/exception.c uart/uart.c pmm/pmm.c test/test_exception.c test/test_pmm.c
